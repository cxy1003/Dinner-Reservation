  ...
  data() {
    return {
     tabBarImgArr:[   //图片切换
        ...
        {normal: require('../img/mine/normalxiaomi.png'), selected: require('../img/mine/succxiaomi.png')},
        {normal: require('../img/mine/normalmine.png'), selected: require('../img/mine/succmine.png')}
      ]
    }
  },
  methods:{
