<template>
    <div>
        <mt-header title="订餐位置">
            <mt-button icon="back" slot="left" @click="backup"></mt-button>
        </mt-header>
        <!-- 地图模块 -->
        <!-- <div class="adress">
            <label class="want_adr">您要去的地方：
                <input v-model="keyword">
            </label>
        </div> -->
        <!-- getPoint方法，给地图加点击事件，点击地图获取所需要的信息，-->
        <!--scroll-wheel-zoom属性是否可以用鼠标滚轮控制地图缩放-->
        <baidu-map class="map" id="mapID" :center="center" :zoom="zoom" :scroll-wheel-zoom="true" @click="getPoint" >
        ...
        <!-- 公交线路图 -->
        <!-- <bm-view class="map" :center="center"></bm-view> -->
            <bm-transit start="西安南洋国际" :end="end" :auto-viewport="true" location="西安">
            </bm-transit>
