...
.xw-score-list li span{
 ...
 nav a{
      float: left;
      background: url(/public/images/star.png) no-repeat -38px 0;
      width: 38px;
      height: 36px;
      margin-right: 10px;
      transition: .3s;
...
html,body,a,button,input,textarea,img,ul,li,p,dl,dd,h1,h2,h3,h4,h5,h6{
  ...
  .xw-ring-icon {
    background: url(/public/images/soundOn.svg) no-repeat 50%;
  }
  
   .xw-ring-icon-toggle{
     background: url(/public/images/soundClose.svg) no-repeat 50%;
  }
  ...
  .xw-chat-tool-btn.xw-face {
     background: url(/public/images/smileOn.svg) no-repeat 50%;
  }
  .xw-chat-tool-btn.xw-face-close {
     background: url(/public/images/smileClose.svg) no-repeat 50%;
  }
  ...
  .xw-hide-operation{
    background: url(/public/images/addOn.svg) no-repeat 50%;
    width: 38px;
    height: 38px;
    margin-right:10px;
    transform:scale(.7);
  ...
  .xw-hide-operation-close{
    background: url(/public/images/addClose.svg) no-repeat 50%;
    width: 38px;
    height: 38px;
    margin-right:10px;
    transform:scale(.7);
  ...
  .xw-samll-pop-wrap{
   ...
   background: url(/public/images/s.jpg) no-repeat;
    z-index: 1000;
  }
  .xw-pop-server{
   background: url(/public/images/s.jpg) no-repeat;
  ...
  .xw-pop-customer{
    ...
    width: 80%;
    height: 200px;
    background: url(/public/images/c.jpg) no-repeat;
    z-index: 101;
    left:50%;
    margin-left: -40%;
    text-align: center;
